      ...
      function(Resource, LoopBackAuth, $injector) {
        ...
        urlBase + "/Users/:id",
          { 'id': '@id' },
          {
            ...
            // INTERNAL. Use CoffeeShop.users.findById() instead.
            "::findById::CoffeeShop::users": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/CoffeeShops/:id/users/:fk",
              method: "GET",
            },

            // INTERNAL. Use CoffeeShop.users.destroyById() instead.
            "::destroyById::CoffeeShop::users": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/CoffeeShops/:id/users/:fk",
            ...
            // INTERNAL. Use CoffeeShop.users.updateById() instead.
            "::updateById::CoffeeShop::users": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/CoffeeShops/:id/users/:fk",
            ...
            // INTERNAL. Use CoffeeShop.users() instead.
            "::get::CoffeeShop::users": {
              isArray: true,
              url: urlBase + "/CoffeeShops/:id/users",
              method: "GET",
            },

            // INTERNAL. Use CoffeeShop.users.create() instead.
            "::create::CoffeeShop::users": {
              url: urlBase + "/CoffeeShops/:id/users",
              method: "POST",
            },

            // INTERNAL. Use CoffeeShop.users.createMany() instead.
            "::createMany::CoffeeShop::users": {
              isArray: true,
              url: urlBase + "/CoffeeShops/:id/users",
              method: "POST",
            },

            // INTERNAL. Use CoffeeShop.users.destroyAll() instead.
            "::delete::CoffeeShop::users": {
              url: urlBase + "/CoffeeShops/:id/users",
              method: "DELETE",
            },

            // INTERNAL. Use CoffeeShop.users.count() instead.
            "::count::CoffeeShop::users": {
              url: urlBase + "/CoffeeShops/:id/users/count",
              method: "GET",
            },
 ...
 */
  module.factory(
    ...
    /**
     * @ngdoc object
     * @name lbServices.CoffeeShop.users
     * @header lbServices.CoffeeShop.users
     * @object
     * @description
     *
     * The object `CoffeeShop.users` groups methods
     * manipulating `User` instances related to `CoffeeShop`.
     *
     * Call {@link lbServices.CoffeeShop#users CoffeeShop.users()}
     ...
     */
        ...
        R.users = function() {
          ...
          var action = TargetResource["::get::CoffeeShop::users"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.CoffeeShop.users#count
             * @methodOf lbServices.CoffeeShop.users
             *
             * @description
             *
             * Counts users of CoffeeShop.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - PersistedModel id
        ...
        R.users.count = function() {
          var TargetResource = $injector.get("User");
          var action = TargetResource["::count::CoffeeShop::users"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.CoffeeShop.users#create
             * @methodOf lbServices.CoffeeShop.users
             *
             * @description
             *
        ...
        R.users.create = function() {
          var TargetResource = $injector.get("User");
          var action = TargetResource["::create::CoffeeShop::users"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.CoffeeShop.users#createMany
             * @methodOf lbServices.CoffeeShop.users
             *
             * @description
             *
        ...
        R.users.createMany = function() {
          var TargetResource = $injector.get("User");
          var action = TargetResource["::createMany::CoffeeShop::users"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.CoffeeShop.users#destroyAll
             * @methodOf lbServices.CoffeeShop.users
             *
             * @description
             *
        ...
        R.users.destroyAll = function() {
          var TargetResource = $injector.get("User");
          var action = TargetResource["::delete::CoffeeShop::users"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.CoffeeShop.users#destroyById
             * @methodOf lbServices.CoffeeShop.users
             *
             * @description
             *
        ...
        R.users.destroyById = function() {
          var TargetResource = $injector.get("User");
          var action = TargetResource["::destroyById::CoffeeShop::users"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.CoffeeShop.users#findById
             * @methodOf lbServices.CoffeeShop.users
             *
             * @description
             *
        ...
        R.users.findById = function() {
          var TargetResource = $injector.get("User");
          var action = TargetResource["::findById::CoffeeShop::users"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.CoffeeShop.users#updateById
             * @methodOf lbServices.CoffeeShop.users
             *
             * @description
             *
        ...
        R.users.updateById = function() {
          var TargetResource = $injector.get("User");
          var action = TargetResource["::updateById::CoffeeShop::users"];
          return action.apply(R, arguments);
        };
    /**
     * @ngdoc object
